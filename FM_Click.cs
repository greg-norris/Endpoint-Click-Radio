...
namespace EndpointClickRadio
{
        ...
        public FM_Click(int reset, int chipSelect)
        {
            ...
            //Wrapper:
            var i2cConnectionSetting = new I2cConnectionSettings(STM32MP1.I2c.I2c4, FM_Click.I2C_ADDRESS);
            i2cController = new I2cController(i2cConnectionSetting);
        ...
        public void SetChannelConfiguration(Spacing spacing, Band band,I2cController i2cController)
        {
        ...
        private void RadioTextWorker(I2cController i2cController)
        {
        ...
        private void InitializeDevice(GpioController resetPin, int pinNumberReset, I2cController i2cController )
        {
        ...
        private void ReadRegisters(I2cController i2cController)
        {
        ...
        private void UpdateRegisters(I2cController i2cController)
        {
        ...
        private void SetDeviceVolume(ushort volume,I2cController i2cController)
        {
            this.ReadRegisters(i2cController);
            this.registers[FM_Click.REGISTER_SYSCONFIG2] &= 0xFFF0;
        ...
        private int GetDeviceChannel(I2cController i2cController)
        {
            this.ReadRegisters(i2cController);
        ...
        private void SetDeviceChannel(int newChannel, I2cController i2cController)
        {
        ...
        private bool SeekDevice(SeekDirection direction, I2cController i2cController)
        {
            this.ReadRegisters(i2cController);
